# Plot escape profiles for Omicron BA1 background MAP
...
```python
print(f"Reading sites of strong escape from {config['strong_escape_sites_Omicron_BA1']}")

strong_escape_sites = pd.read_csv(config['strong_escape_sites_Omicron_BA1'])
```

    Reading sites of strong escape from results/escape_profiles/strong_escape_sites_Omicron_BA1.csv
...
wt_prot = str(Bio.SeqIO.read(config['wildtype_sequence_Omicron_BA1'], 'fasta').seq.translate())
...
for prop in ['bind', 'expr']:
    ...
    for orientation in ['horizontal', 'vertical']:
        scalebar_file = os.path.join(config['escape_profiles_dir_Omicron_BA1'], f"{prop}_scalebar_{orientation}.pdf")
    ...
    print(f"Saving DMS color scheme to {config['escape_profiles_dms_colors_Omicron_BA1']}")
    (mut_bind_expr
     .query('escape_gt_0')
     .drop(columns='escape_gt_0')
     .to_csv(config['escape_profiles_dms_colors_Omicron_BA1'], index=False)
     )
...
```
    ...
    bind ranges from -1.98304 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/Omicron_BA1/bind_scalebar_horizontal.pdf



    
![png](escape_profiles_Omicron_BA1_files/escape_profiles_Omicron_BA1_18_1.png)
    


    
    bind ranges from -1.98304 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/Omicron_BA1/bind_scalebar_vertical.pdf



    
![png](escape_profiles_Omicron_BA1_files/escape_profiles_Omicron_BA1_18_3.png)
    


    Saving DMS color scheme to results/escape_profiles/Omicron_BA1/escape_profiles_dms_colors.csv
    
    expr ranges from -0.83197 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/Omicron_BA1/expr_scalebar_horizontal.pdf



    
![png](escape_profiles_Omicron_BA1_files/escape_profiles_Omicron_BA1_18_5.png)
    


    
    expr ranges from -0.83197 to 0.0, here is the scale bar, which is being saved to results/escape_profiles/Omicron_BA1/expr_scalebar_vertical.pdf



    
![png](escape_profiles_Omicron_BA1_files/escape_profiles_Omicron_BA1_18_7.png)
...
```python
print(f"Reading escape-profile configuration from {config['escape_profiles_config_Omicron_BA1']}")
...
```
    ...
    Reading escape-profile configuration from data/escape_profiles_config_Omicron_BA1.yaml
...
for name, specs in escape_profiles_config.items():
    ...
    # write the ylimits
    ylims_csv = os.path.join(config['escape_profiles_dir_Omicron_BA1'], f"{name}_stackedlogo_ylims.csv")
    (
    ...
    colors_plotfiles = [(color_col, os.path.join(config['escape_profiles_dir_Omicron_BA1'], f"{name}_stackedlogo.pdf"))]
    if 'color_by_dms' in specs and specs['color_by_dms']:
        colors_plotfiles += [('bind_color', os.path.join(config['escape_profiles_dir_Omicron_BA1'], f"{name}_color_by_bind_stackedlogo.pdf")),
                             ('expr_color', os.path.join(config['escape_profiles_dir_Omicron_BA1'], f"{name}_color_by_expr_stackedlogo.pdf"))]
...
```
    ...
    Plotted profile 1 to:
     results/escape_profiles/Omicron_BA1/all_mAbs_BA1_stackedlogo.pdf
     results/escape_profiles/Omicron_BA1/all_mAbs_BA1_stackedlogo.png.



    
![png](escape_profiles_Omicron_BA1_files/escape_profiles_Omicron_BA1_26_1.png)
    


    
    Plotted profile 2 to:
     results/escape_profiles/Omicron_BA1/all_mAbs_BA1_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Omicron_BA1/all_mAbs_BA1_color_by_bind_stackedlogo.png.



    
![png](escape_profiles_Omicron_BA1_files/escape_profiles_Omicron_BA1_26_3.png)
    


    
    Plotted profile 3 to:
     results/escape_profiles/Omicron_BA1/all_mAbs_BA1_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Omicron_BA1/all_mAbs_BA1_color_by_expr_stackedlogo.png.



    
![png](escape_profiles_Omicron_BA1_files/escape_profiles_Omicron_BA1_26_5.png)
    


    
    Plotted profile 4 to:
     results/escape_profiles/Omicron_BA1/28C3_BA1_stackedlogo.pdf
     results/escape_profiles/Omicron_BA1/28C3_BA1_stackedlogo.png.



    
![png](escape_profiles_Omicron_BA1_files/escape_profiles_Omicron_BA1_26_7.png)
    


    
    Plotted profile 5 to:
     results/escape_profiles/Omicron_BA1/28C3_BA1_color_by_bind_stackedlogo.pdf
     results/escape_profiles/Omicron_BA1/28C3_BA1_color_by_bind_stackedlogo.png.



    
![png](escape_profiles_Omicron_BA1_files/escape_profiles_Omicron_BA1_26_9.png)
    


    
    Plotted profile 6 to:
     results/escape_profiles/Omicron_BA1/28C3_BA1_color_by_expr_stackedlogo.pdf
     results/escape_profiles/Omicron_BA1/28C3_BA1_color_by_expr_stackedlogo.png.



    
![png](escape_profiles_Omicron_BA1_files/escape_profiles_Omicron_BA1_26_11.png)
